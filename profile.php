                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td><?php echo date('M d, Y', strtotime($user_info['created_at'])); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Account Status:</strong></td>
                            <td>
                                <span class="badge bg-<?php echo $user_info['is_active'] ? 'success' : 'danger'; ?>">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-4">
                            <h4 class="text-success"><?php echo $stats['delivered_orders']; ?></h4>
                            <small class="text-muted">Delivered</small>
                        </div>
                        <div class="col-4">
                            <h4 class="text-warning"><?php echo formatPrice($stats['total_spent']); ?></h4>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="products/product-list.php" class="btn btn-outline-info">
