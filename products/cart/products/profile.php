...
// Get recent orders
$recent_orders_query = "SELECT * FROM orders WHERE user_id = ? ORDER BY order_date DESC LIMIT 3";
        ...
        <div class="col-lg-4 mb-4">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="stat-item">
                        <div class="d-flex justify-content-between align-items-center">
                            <span><i class="fas fa-clock text-info me-2"></i>Last Order</span>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       value="<?php echo date('F d, Y g:i A', strtotime($user_info['created_at'])); ?>" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
