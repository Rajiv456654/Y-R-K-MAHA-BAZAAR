...
$sort_options = [
    ...
    'popular' => 'p.name ASC' // Could be based on sales data
];
...
$page_title = !empty($search) ? "Search Results for: " . htmlspecialchars($search) : "Discover Amazing Products";
...
<div class="container">
    ...
    <div class="alert alert-info mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <strong>Search Query:</strong> "<?php echo htmlspecialchars($search); ?>" 
                <span class="ms-3"><strong>Results:</strong> <?php echo $total_records; ?> products found</span>
                <?php if ($total_records == 0): ?>
                <div class="mt-2">
                    <small>Try different keywords or <a href="product-list.php">browse all products</a></small>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card filter-card mb-4">
        <div class="card-header bg-gradient text-white">
            <h5 class="mb-0"><i class="fas fa-filter me-2"></i>Filter & Sort Products</h5>
        </div>
        <div class="card-body">
    ...
    <div class="text-center py-5">
        ...
        <p class="text-muted mb-4">
            We couldn't find any products matching "<strong><?php echo htmlspecialchars($search); ?></strong>"
        </p>
        <div class="mb-4">
        ...
        <?php else: ?>
        <p class="text-muted mb-4">No products are currently available.</p>
