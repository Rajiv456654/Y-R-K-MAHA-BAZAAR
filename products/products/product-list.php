...
$page_title = !empty($search) ? "Search: " . htmlspecialchars($search) : "All Products";
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="lead text-white-50 mb-4">Found <?php echo $total_records; ?> products for "<?php echo htmlspecialchars($search); ?>"</p>
                <?php else: ?>
                <h1 class="display-4 fw-bold text-white mb-3">🛍️ All Products</h1>
                <p class="lead text-white-50 mb-4">Discover our complete collection of amazing products</p>
                <?php endif; ?>
...
<div class="container">
    ...
    <div class="alert alert-primary mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h5 class="mb-1">Search Results for: "<?php echo htmlspecialchars($search); ?>"</h5>
                <p class="mb-0">
                    <?php if ($total_records > 0): ?>
                    Found <strong><?php echo $total_records; ?></strong> matching products
                    <?php else: ?>
    ...
    <div class="card filter-card mb-4">
        <div class="card-header bg-gradient text-white">
            <h5 class="mb-0"><i class="fas fa-sliders-h me-2"></i>Filter & Sort Products</h5>
        </div>
        <div class="card-body">
