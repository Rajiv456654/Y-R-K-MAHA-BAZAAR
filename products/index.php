...
<div class="hero-gradient py-5 mb-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-4 fw-bold text-white mb-3">Welcome to Our Products Hub</h1>
                <p class="lead text-white-50 mb-4">Discover amazing products across all categories with unbeatable prices and premium quality</p>
